        ...
        <form>
          <div :class="{on :isShowbg}">
            <section class="login_message">
              <input type="tel" maxlength="11" placeholder="手机号" v-model="phon"/>
              <button :disabled="!isShowpsw " :class="{right_phone_number:isShowpsw}" @click.prevent="yanzhengma" class="get_verification">获取验证码</button>
            </section>
          ...
          <div :class="{on :!isShowbg}">
            <section>
              ...
              <section class="login_verification">
                <input :type="isShowpassWord ? 'text':'password' "  maxlength="8" placeholder="密码" />
